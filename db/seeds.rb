...
favourites = List.create!(name: "Favourite movies")
...
Bookmark.create!(
  movie: wonder_woman,
  list: favourites,
  comment: "Amazing action scenes"
)

Bookmark.create!(
  movie: shawshank,
  list: drama,
  comment: "Best prison drama ever"
)
